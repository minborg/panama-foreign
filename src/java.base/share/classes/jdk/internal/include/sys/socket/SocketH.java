...
package jdk.internal.include.sys.socket;
...
/*        var mh$ = connect$MH();
     ...
     * @see <a href="https://man7.org/linux/man-pages/man2/connect.2.html">connect</a> for further details.
     */
    public static int connect(MemorySegment errCap, int sockfd, MemorySegment addr, int addlen) {
        try {
     ...
     */
    public static long recvfrom(MemorySegment errCap,
                                int socket,
     ...
     */
    public static long sendto(MemorySegment errCap,
                              int socket,
     ...
     */
    public static int disconnectx(MemorySegment errCap, int socket, int associd, int connid) {
        try {
...
/*
    ...
    static {
        ...
        var connectCapture = CaptureCallStateUtil
                .createCapture("connect", constants$0.connect$FUNC, CaptureCallStateUtil.ERRNO);
        ...
        RECVFROM_MH = CaptureCallStateUtil
                .createCapture("recvfrom", constants$0.recvfrom$FUNC, CaptureCallStateUtil.ERRNO)
                .methodHandle();

        SENDTO_MH = CaptureCallStateUtil
                .createCapture("sendto", constants$0.sendto$FUNC, CaptureCallStateUtil.ERRNO)
                .methodHandle();

        DISCONNECTX_MH = CaptureCallStateUtil
                .createCapture("disconnectx", constants$0.disconnectx$FUNC, CaptureCallStateUtil.ERRNO)
                .methodHandle();
