...
public class sockaddr_in {
    ...
    static final StructLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_SHORT$LAYOUT.withName("sin_port").withOrder(ByteOrder.BIG_ENDIAN),
        MemoryLayout.structLayout(
            Constants$root.C_INT$LAYOUT.withName("s_addr").withOrder(ByteOrder.BIG_ENDIAN)
        ).withName("sin_addr"),
