...
public class iovec {
    ...
    static final VarHandle iov_base$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("iov_base"));
    public static VarHandle iov_base$VH() {
        return iovec.iov_base$VH;
    }
    public static MemorySegment iov_base$get(MemorySegment seg) {
        return (MemorySegment)iovec.iov_base$VH.get(seg);
    }
    ...
    public static MemorySegment iov_base$get(MemorySegment seg, long index) {
        return (MemorySegment)iovec.iov_base$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle iov_len$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("iov_len"));
