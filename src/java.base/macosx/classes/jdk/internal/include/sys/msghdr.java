...
public class msghdr {
    ...
    public static MemorySegment msg_name$get(MemorySegment seg, long index) {
        return (MemorySegment)msghdr.msg_name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle msg_namelen$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("msg_namelen"));
    ...
    static final VarHandle msg_iov$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("msg_iov"));
    public static VarHandle msg_iov$VH() {
        return msghdr.msg_iov$VH;
    }
    public static MemorySegment msg_iov$get(MemorySegment seg) {
        return (MemorySegment)msghdr.msg_iov$VH.get(seg);
    }
    ...
    public static MemorySegment msg_iov$get(MemorySegment seg, long index) {
        return (MemorySegment)msghdr.msg_iov$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle msg_iovlen$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("msg_iovlen"));
    public static VarHandle msg_iovlen$VH() {
        return msghdr.msg_iovlen$VH;
    }
    public static int msg_iovlen$get(MemorySegment seg) {
        return (int)msghdr.msg_iovlen$VH.get(seg);
    }
    public static void msg_iovlen$set(MemorySegment seg, int x) {
        msghdr.msg_iovlen$VH.set(seg, x);
    }
    public static int msg_iovlen$get(MemorySegment seg, long index) {
        return (int)msghdr.msg_iovlen$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void msg_iovlen$set(MemorySegment seg, long index, int x) {
        msghdr.msg_iovlen$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle msg_control$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("msg_control"));
    ...
    public static MemorySegment msg_control$get(MemorySegment seg) {
        return (MemorySegment)msghdr.msg_control$VH.get(seg);
    }
    ...
    public static MemorySegment msg_control$get(MemorySegment seg, long index) {
        return (MemorySegment)msghdr.msg_control$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final VarHandle msg_controllen$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("msg_controllen"));
    public static VarHandle msg_controllen$VH() {
        return msghdr.msg_controllen$VH;
    }
    public static int msg_controllen$get(MemorySegment seg) {
        return (int)msghdr.msg_controllen$VH.get(seg);
    }
    public static void msg_controllen$set(MemorySegment seg, int x) {
        msghdr.msg_controllen$VH.set(seg, x);
    }
    public static int msg_controllen$get(MemorySegment seg, long index) {
        return (int)msghdr.msg_controllen$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void msg_controllen$set(MemorySegment seg, long index, int x) {
        msghdr.msg_controllen$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle msg_flags$VH = $struct$LAYOUT.varHandle(PathElement.groupElement("msg_flags"));
