...
import static jdk.internal.foreign.mapper.accessor.AccessorInfo.AccessorType.*;
import static jdk.internal.foreign.mapper.accessor.Cardinality.*;
import static jdk.internal.foreign.mapper.accessor.ValueType.*;
...
public record AccessorInfo(Key key,
    ...
    public AccessorInfo ofMethod(Key key, Method method, Class<?> type, LayoutInfo layoutInfo, long offset) {
        return new AccessorInfo(key,  method, null, type, layoutInfo, offset);
    }

    public AccessorInfo ofComponent(Key key, RecordComponent recordComponent, Class<?> type, LayoutInfo layoutInfo, long offset) {
        return new AccessorInfo(key,  recordComponent.getAccessor(), recordComponent, type, layoutInfo, offset);
    }
    ...
    public enum Key {
        ...
        SCALAR_VALUE_GETTER    (SCALAR, VALUE,     GETTER, EnumSet.of(INTERFACE, RECORD  )),
        ...
        SCALAR_RECORD_GETTER   (SCALAR, RECORD,    GETTER, EnumSet.of(INTERFACE, RECORD  )),
        SCALAR_RECORD_SETTER   (SCALAR, RECORD,    SETTER, EnumSet.of(INTERFACE          )),
        ARRAY_VALUE_GETTER     (ARRAY,  VALUE,     GETTER, EnumSet.of(INTERFACE, RECORD  )),
        ...
        ARRAY_RECORD_GETTER    (ARRAY,  RECORD,    GETTER, EnumSet.of(INTERFACE, RECORD  )),
        ARRAY_RECORD_SETTER    (ARRAY,  RECORD,    SETTER, EnumSet.of(INTERFACE          ));
